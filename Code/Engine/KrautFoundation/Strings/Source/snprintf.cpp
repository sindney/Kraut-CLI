...
namespace AE_NS_FOUNDATION
{
  ...
  int aeStringFunctions::vsnprintf (char* szOutputBuffer, unsigned int uiBufferSize, const char* szFormat, va_list& args)
  {
  ...
  int aeStringFunctions::snprintf (char* szOutputBuffer, unsigned int uiBufferSize, const char* szFormat, ...)
  {
    va_list args;
